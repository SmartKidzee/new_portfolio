      ...
      {visible && (
        ...
        >
          <div className="relative group">
            ...
            <div className="absolute -inset-1 bg-gradient-to-r from-vibrant-orange to-vibrant-orange-gradient opacity-70 rounded-2xl blur transition-all group-hover:blur-md group-hover:opacity-80"></div>
            
            <div className="relative bg-vibrant-bg text-white px-4 py-3 sm:px-6 sm:py-4 rounded-xl shadow-lg border border-white/10 backdrop-blur-lg flex items-center gap-3 group-hover:shadow-xl transition-all duration-300">
              <div className="flex items-center gap-2 text-sm sm:text-base overflow-hidden">
                {loading ? (
                  ...
                  <>
                    <div className="flex-shrink-0 text-vibrant-orange">
